...
/* instagram bar */
.ig-bar{background:var(--navy-deep); padding:26px 0;}
.ig-bar .wrap{display:flex; align-items:center; justify-content:space-between; gap:20px; flex-wrap:wrap;}
.ig-bar .left{display:flex; align-items:center; gap:18px; color:#fff;}
.ig-bar .ic{width:46px; height:46px; border-radius:13px; border:2.5px solid var(--sky); color:var(--sky); display:flex; align-items:center; justify-content:center; flex-shrink:0;}
.ig-bar .t1{font-family:'Anton', sans-serif; font-size:17px; letter-spacing:0.06em; text-transform:uppercase;}
.ig-bar .t2{font-size:13.5px; font-weight:600; color:rgba(255,255,255,0.65); margin-top:3px;}
.ig-btn{background:var(--sky); color:var(--navy-deep) !important; font-family:'Anton', sans-serif; font-size:13px; letter-spacing:0.06em; text-transform:uppercase; padding:13px 24px; border-radius:3px; transition:background .15s ease, transform .15s ease; white-space:nowrap;}
.ig-btn:hover{background:#fff; transform:translateY(-1px);}
...
<div class="ig-bar">
  <div class="wrap">
    <a class="left" href="https://www.instagram.com/barrierugby" target="_blank" rel="noopener">
      <span class="ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1"/></svg></span>
      <span><span class="t1">@barrierugby on Instagram</span><br><span class="t2">Match photos, results, and team news all season long.</span></span>
    </a>
    <a class="ig-btn" href="https://www.instagram.com/barrierugby" target="_blank" rel="noopener">Follow &rarr;</a>
  </div>
</div>
